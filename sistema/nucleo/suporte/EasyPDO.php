...
class EasyPDO
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $str = "mysql:host={$this->db_host};port=3307;dbname={$this->db_name};charset={$this->db_char}";
        ...
        // --------------------------------------------------------------------
        // set attributes
        $this->connection->setAttribute(PDO::ATTR_ERRMODE, $this->opt_attr_errmode); //traz as mesangens de erro
        $this->connection->setAttribute(PDO::ATTR_CASE, $this->opt_attr_case); //retorna o nome das colunas igual o bd
